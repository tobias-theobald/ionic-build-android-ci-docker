...
RUN echo 'y' | /opt/android-sdk-linux/tools/android update sdk -u -a -t platform-tools,build-tools-25,android-25,extra-android-support,extra-google-m2repository,extra-android-m2repository #redo
